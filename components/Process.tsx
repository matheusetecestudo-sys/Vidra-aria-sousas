        ...
        <div className="mt-16 reveal active border-t border-white/5 pt-16">
          <div className="flex flex-col items-center text-center gap-12">
            ...
            <a
              ...
              className="h-16 w-full sm:w-auto flex items-center justify-center gap-3 px-10 bg-brand-accent hover:bg-brand-secondary text-white rounded-xl font-bold text-base btn-interact shadow-lg shadow-brand-accent/20 hover:shadow-xl hover:shadow-brand-accent/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
            >
