    ...
    <section id="solucoes" className="py-8 pb-16 md:py-10 bg-white font-inter">
      <div className="container-precision">
        <div className="text-center mb-8 reveal active">
          ...
          <h2 className="text-4xl md:text-6xl font-black !text-brand-primary mb-8 tracking-tight leading-[1] text-center">
            Portfólio de <br />
            <span className="text-brand-accent font-medium italic">Soluções Vidreiras.</span>
          </h2>
        </div>
          ...
          {galleryServices.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end items-center text-center p-4 pb-8 md:pb-10">
                ...
                <div className="inline-flex items-center gap-2 bg-brand-primary text-white text-[10px] md:text-[11px] font-bold px-4 py-2.5 rounded-xl transition-all duration-500 opacity-100 md:opacity-0 md:group-hover:opacity-100 shadow-xl whitespace-nowrap scale-90 md:scale-100">
